        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <img
                src="https://github.com/sejal-godbole.png"
                alt="Sejal Godbole"
                className="w-24 h-24 rounded-full object-cover absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-primary/50"
                onError={(e) => {
            ...
            <div className="space-y-4">
              ...
              >
                <span className="text-primary">CSE-AI Student</span> @ VIIT | Full Stack Developer
              </motion.p>
            </div>
            ...
            >
              <a
                href="#work"
                className="group inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground rounded-full font-medium transition-all hover:shadow-neon"
              >
                View Work
              ...
              <RoughHighlight type="circle" color="#00f2ff" delay={1500} strokeWidth={2}>
                <a
                  href="#contact"
                  className="inline-flex items-center gap-2 px-8 py-4 text-foreground rounded-full font-medium transition-all hover:text-primary"
                >
